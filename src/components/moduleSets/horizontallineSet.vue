...
export default {
    ...
    created: function() {
        this.borderStyle=this.borderData.borderTopStyle;
        this.borderWidth=this.borderData.borderTopWidth;
        this.borderColor=(this.borderData.borderTopColor=='initial' || this.borderData.borderTopColor=='')?"":this.borderData.borderTopColor;
        if(this.borderColor==''){
    ...
    methods: {
        ...
        save: function(e) {
            let _this=this;
            let bt = this.borderWidth + "px " + this.borderStyle + " " + this.borderNewColor;
