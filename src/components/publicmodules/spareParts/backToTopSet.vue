<template>
    <el-tabs type="border-card">
        ...
        <li class="background-set-part bg-view">
            <span class="background-view" :style="{backgroundImage:'url('+backgroundImage.imgUrl+')'}"></span>
        ...
        <li class="backgroundNormalColor">悬停图片</li>
            <li class="background-set-part bg-view">
            <span class="background-view" :style="{backgroundImage:'url('+backgroundImage.imgUrl_1+')'}"></span>
            <div class="el-button-group">
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            backgroundImage(){
                return this.pageInfo.floatModules[0].slotModeules[0].moduleSet.advancedSetting
            }
        },
        methods: {
            ...mapActions([
            ...
            setBGImgNone:function(b) {
                b?this.pageInfo.floatModules[0].slotModeules[0].moduleSet.advancedSetting.imgUrl="none":this.pageInfo.floatModules[0].slotModeules[0].moduleSet.advancedSetting.imgUrl_1="none"
            },
            save:function(){
                    //更新数据同步模块
                this.pageInfo.floatModules[0].slotModeules[0]['$styles']['container'].right = this.right+'px';
                this.pageInfo.floatModules[0].slotModeules[0]['$styles']['container'].bottom = this.bottom+'px';
                this.pageInfo.floatModules[0].slotModeules[0]['$styles']['container'].width = this.width+'px';
        ...
        created(){
            let _this=this
            _this.right=parseInt(this.pageInfo.floatModules[0].slotModeules[0]['$styles']['container'].right)
            _this.bottom=parseInt(this.pageInfo.floatModules[0].slotModeules[0]['$styles']['container'].bottom)
            _this.width=parseInt(this.pageInfo.floatModules[0].slotModeules[0]['$styles']['container'].width)
        }
    }
</script>
<style>
